namespace MBuildingBlock.External
{
    public class MAuthInfoContext
    {
        ...
        public MAuthInfoContext(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public MAuthInfoContext(IHttpContextAccessor httpContextAccessor, ResourceSetting resourceSetting)
        {
            string authorizationHeader = "Authorization";
            string? token = httpContextAccessor.HttpContext?.Request.Headers[authorizationHeader];
            string? language = httpContextAccessor.HttpContext?.Request.Headers.AcceptLanguage.ToString().Split(',').FirstOrDefault();
        ...
        public MAuthInfoContext(IAmqpContext amqpContext)
        {
