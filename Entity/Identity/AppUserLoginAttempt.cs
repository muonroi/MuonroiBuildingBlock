namespace MuonroiBuildingBlock.Entity.Identity
{
    ...
    public class AppUserLoginAttempt : EntityBase
    {
        ...
        /// </summary>
        public virtual MuonroiLoginResultType Result { get; set; }

        public virtual DateTime CreationTime { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="AppUserLoginAttempt"/> class.
        /// </summary>
